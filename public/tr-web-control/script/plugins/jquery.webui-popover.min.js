  ...
  !(function (b) {
    ...
    var f = 'webuiPopover',
      ...
      v = function (a) {
        ...
        if (
          ...
          ('mousedown' === a.type || 'mouseup' === a.type || 'click' === a.type) &&
    ...
    (e.prototype = {
        ...
        'manual' !== this.getTrigger() &&
          (u
            ? this.$element
                ...
                .on('touchend', this.options.selector, d.proxy(this.toggle, this))
            ...
            : 'hover' === this.getTrigger() &&
              this.$element
                ...
                .on('mouseenter', this.options.selector, d.proxy(this.mouseenterHandler, this))
                .on('mouseleave', this.options.selector, d.proxy(this.mouseleaveHandler, this))),
          (this._poped = !1),
          (this._inited = !0),
          (this._opened = !1),
          (this._idSeed = m),
          ...
          this.options.selector && (this._options = d.extend({}, this.options, { selector: '' }));
      },
      destroy: function () {
        ...
        k.splice(a, 1),
          ...
          'click' === this.getTrigger()
            ...
            : 'hover' === this.getTrigger() && this.$element.off('mouseenter mouseleave'),
      ...
      displayContent: function () {
        ...
        if (
          (this.$target.css(p.position).addClass(i).addClass('in'), 'iframe' === this.options.type)
        ) {
          var q = b.find('iframe'),
            r = b.width(),
            s = q.parent().height();
        ...
        if ((this.options.arrow || this.$target.css({ margin: 0 }), this.options.arrow)) {
          ...
          t.removeAttr('style'),
            'left' === i || 'right' === i
              ...
              : ('top' === i || 'bottom' === i) && t.css({ left: this.$target.width() / 2 }),
            p.arrowOffset &&
        ...
        if (!this.$target) {
          ...
          (this.$target = d(this.options.template).attr('id', a)),
            (this._customTargetClass =
              this.$target.attr('class') !== g ? this.$target.attr('class') : null),
      ...
      getContentElement: function () {
        return (
          this.$contentElement ||
            (this.$contentElement = this.getTarget().find('.' + g + '-content')),
          this.$contentElement
        );
      },
      getTitle: function () {
        return (
          this.$element.attr('data-title') || this.options.title || this.$element.attr('title')
        );
      },
      getUrl: function () {
      ...
      setTitle: function (a) {
        ...
        a
          ? ('rtl' !== this.options.direction || b.hasClass(j) || b.addClass(j), b.html(a))
          : b.remove();
      },
      hasContent: function () {
          ...
          (this.options.dismissible && 'click' === this.getTrigger()
            ? u
              ? p
                  ...
                  .on('touchstart.webui-popover', d.proxy(this.bodyTouchStartHandler, this))
              : (p
                  .off('keyup.webui-popover')
                  .on('keyup.webui-popover', d.proxy(this.escapeHandler, this)),
                p
                  .off('click.webui-popover')
                  .on('click.webui-popover', d.proxy(this.bodyClickHandler, this)))
            : 'hover' === this.getTrigger() &&
              p
                .off('touchend.webui-popover')
                .on('touchend.webui-popover', d.proxy(this.bodyClickHandler, this)));
      },
      ...
      getPlacement: function (a) {
        ...
        b =
          'function' == typeof this.options.placement
            ? this.options.placement.call(this, this.getTarget()[0], this.$element[0])
          ...
          l
            ? (b =
                d / 3 > h
                  ...
                  : 'top-left')
            : 'auto-top' === b
            ? (b = d / 3 > h ? 'top-right' : (2 * d) / 3 > h ? 'top' : 'top-left')
            : 'auto-bottom' === b
            ? (b = d / 3 > h ? 'bottom-right' : (2 * d) / 3 > h ? 'bottom' : 'bottom-left')
            : 'auto-left' === b
            ? (b = e / 3 > i ? 'left-top' : (2 * e) / 3 > i ? 'left' : 'left-bottom')
            : 'auto-right' === b &&
              (b = e / 3 > i ? 'right-bottom' : (2 * e) / 3 > i ? 'right' : 'right-top'),
          b
        );
      },
        ...
        var c = [],
          g = this.each(function () {
            ...
            g
              ...
              : (a
                  ? 'string' == typeof a
                    ? 'destroy' !== a && (b || ((g = new e(this, null)), c.push(g[a]())))
