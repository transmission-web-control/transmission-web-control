...
JSON || (JSON = {}), (function() {
  ...
  function r(i, e) {
    ...
    switch (typeof o) {
      ...
      case'object':
        ...
        if (t && typeof t == 'object') for (a = t.length, h = 0; h < a; h += 1) typeof t[h] == 'string' && (l = t[h], c = r(l, o), c && s.push(f(l) + (n ? ': ' : ':') + c)); else for (l in o) Object.prototype.hasOwnProperty.call(o, l) && (c = r(l, o), c && s.push(f(l) + (n ? ': ' : ':') + c));
        return c = s.length === 0 ? '{}' : n ? '{\n' + n + s.join(',\n' + n) + '\n' + v + '}' : '{' + s.join(',') + '}', n = v, c;
    }
  }
  ...
  typeof JSON.stringify != 'function' && (JSON.stringify = function(i, f, e) {
    var o;
    n = '', u = '';
    if (typeof e == 'number') for (o = 0; o < e; o += 1) u += ' '; else typeof e == 'string' && (u = e);
    t = f;
